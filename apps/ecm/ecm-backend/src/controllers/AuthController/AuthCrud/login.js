...
const loginUser = async (req, res) => {
  try {
   ...
   ).select('password isVerified fullname email username phone isAdmin photo lastActivityAt role'); // Explicitly select relevant fields

  

console.log("login data in console ", userData)
